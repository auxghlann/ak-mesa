...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${inter.variable} ${jetbrainsMono.variable}`}>
      ...
      <body className="min-h-screen flex flex-col md:flex-row relative font-sans bg-surface text-on-surface antialiased">
        <Sidebar />
        <div className="flex flex-col flex-grow w-full pb-20 md:pb-0">
          ...
          <footer className="bg-surface-container-lowest border-t border-outline-variant w-full py-8 mt-12">
            <div className="flex flex-col md:flex-row justify-between items-center px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto gap-base">
              <Link href="/" className="flex items-center md:hidden" aria-label="Allan Khester Mesa - Home">
                <img src="/logo.png" alt="Allan Khester Mesa" className="h-8 w-auto object-contain" />
              </Link>
              <span className="font-body-md text-body-md text-on-surface-variant md:text-left text-center">
